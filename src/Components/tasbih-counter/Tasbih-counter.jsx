...
const Tasbih = () => {
     ...
     const totalTasbihCount = () => {
          ...
          totalCounter >  32  && totalCounter < 66 && setAlhamdulillahCounter(alhamdulillahCounter + 1)
          totalCounter > 65 && totalCounter < 100 && setAllahuAkbarCounter(allahuAkbarCounter + 1)
     }
